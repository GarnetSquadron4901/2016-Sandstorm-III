...
<Project Type="Project" LVVersion="11008008">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Read Autonomous.vi" Type="VI" URL="../Robot Code/Read Autonomous.vi"/>
		<Item Name="Write Autonomous.vi" Type="VI" URL="../Write Autonomous.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="Autonomous Recording TypeDef.ctl" Type="VI" URL="../Shared/Autonomous Recording TypeDef.ctl"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
	<Item Name="RT CompactRIO Target" Type="RT CompactRIO">
		<Property Name="alias.name" Type="Str">RT CompactRIO Target</Property>
		<Property Name="alias.value" Type="Str">10.03.64.2</Property>
...
KeepAliveTimeout 60
		...
		<Item Name="TypeDefs" Type="Folder">
			...
			<Item Name="DashboardEnable.ctl" Type="VI" URL="../Robot Code/DashboardEnable.ctl"/>
			<Item Name="cRIO Performance Details.ctl" Type="VI" URL="../Shared/cRIO Performance Details.ctl"/>
			<Item Name="Apendage State.ctl" Type="VI" URL="../Robot Code/Apendage State.ctl"/>
			<Item Name="CPU Load.ctl" Type="VI" URL="../Robot Code/CPU Load.ctl"/>
			<Item Name="Autonomous Mode Selector.ctl" Type="VI" URL="../Robot Code/Autonomous Mode Selector.ctl"/>
		...
		<Item Name="Team Code" Type="Folder">
			...
			<Item Name="Control Loops" Type="Folder">
				<Item Name="Shooter Code" Type="Folder">
					<Item Name="Encoder to RPM.vi" Type="VI" URL="../Robot Code/Encoder to RPM.vi"/>
					<Item Name="Shooter Controller.vi" Type="VI" URL="../Robot Code/Shooter Controller.vi"/>
					<Item Name="Shooter Global.vi" Type="VI" URL="../Robot Code/Shooter Global.vi"/>
					<Item Name="Cypress LED Controller.vi" Type="VI" URL="../Robot Code/Cypress LED Controller.vi"/>
				</Item>
				<Item Name="Shifter" Type="Folder">
					<Item Name="Shifter Control Loop.vi" Type="VI" URL="../Robot Code/Shifter Control Loop.vi"/>
					<Item Name="Shifter State.ctl" Type="VI" URL="../Shared/Shifter State.ctl"/>
					<Item Name="Set Shifter (Enum).vi" Type="VI" URL="../Robot Code/Set Shifter (Enum).vi"/>
					<Item Name="Set Shifter (Bool).vi" Type="VI" URL="../Robot Code/Set Shifter (Bool).vi"/>
				</Item>
				<Item Name="Arm" Type="Folder">
					<Item Name="Set Arm (Bool).vi" Type="VI" URL="../Robot Code/Set Arm (Bool).vi"/>
					<Item Name="Arm Control Loop.vi" Type="VI" URL="../Robot Code/Arm Control Loop.vi"/>
					<Item Name="Set Arm (Enum).vi" Type="VI" URL="../Robot Code/Set Arm (Enum).vi"/>
				</Item>
				<Item Name="Horn" Type="Folder">
					<Item Name="Horn Control Loop.vi" Type="VI" URL="../Robot Code/Horn Control Loop.vi"/>
					<Item Name="Set Horn (Enum).vi" Type="VI" URL="../Robot Code/Set Horn (Enum).vi"/>
					<Item Name="Set Horn(Bool).vi" Type="VI" URL="../Robot Code/Set Horn(Bool).vi"/>
				</Item>
				<Item Name="Compressor" Type="Folder">
					<Item Name="Compressor Loop.vi" Type="VI" URL="../Robot Code/Compressor Loop.vi"/>
				</Item>
				<Item Name="Performance Monitor.vi" Type="VI" URL="../Robot Code/Performance Monitor.vi"/>
				<Item Name="Autonomous Recorder.vi" Type="VI" URL="../Robot Code/Autonomous Recorder.vi"/>
			</Item>
			<Item Name="Begin.vi" Type="VI" URL="../Robot Code/Begin.vi"/>
			<Item Name="Periodic Tasks.vi" Type="VI" URL="../Robot Code/Periodic Tasks.vi"/>
			<Item Name="Autonomous Independent.vi" Type="VI" URL="../Robot Code/Autonomous Independent.vi"/>
			<Item Name="Teleop.vi" Type="VI" URL="../Robot Code/Teleop.vi"/>
			<Item Name="Disabled.vi" Type="VI" URL="../Robot Code/Disabled.vi"/>
			<Item Name="Finish.vi" Type="VI" URL="../Robot Code/Finish.vi"/>
			<Item Name="Vision Processing.vi" Type="VI" URL="../Robot Code/Vision Processing.vi"/>
			<Item Name="Analog Ratio to Digital Switches.vi" Type="VI" URL="../Robot Code/Analog Ratio to Digital Switches.vi"/>
			<Item Name="Build DashBoard Data.vi" Type="VI" URL="../Robot Code/Build DashBoard Data.vi"/>
			<Item Name="Robot Global Data.vi" Type="VI" URL="../Robot Code/Robot Global Data.vi"/>
			<Item Name="Shooter Control Mode Converter.vi" Type="VI" URL="../Robot Code/Shooter Control Mode Converter.vi"/>
			<Item Name="Brake.vi" Type="VI" URL="../Robot Code/Brake.vi"/>
			<Item Name="Create Recorder File Path.vi" Type="VI" URL="../Robot Code/Create Recorder File Path.vi"/>
			<Item Name="Simple Solenoid Controller.vi" Type="VI" URL="../Robot Code/Simple Solenoid Controller.vi"/>
		</Item>
		<Item Name="Vision Support Code" Type="Folder"/>
		<Item Name="Support Code" Type="Folder">
			<Item Name="Get Robot Competition Mode.vi" Type="VI" URL="../Robot Code/Get Robot Competition Mode.vi"/>
			<Item Name="Elapsed Times.vi" Type="VI" URL="../Robot Code/Elapsed Times.vi"/>
		</Item>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="RTExe_localDestPath" Type="Path">../2012 Robot Code - Ryan's Version (Cleaned) 2-24-12/Builds/FRC cRIO Application</Property>
				<Property Name="Source[0].itemID" Type="Str">{4223A9A0-846F-4C62-8D59-0A16F92D4CFD}</Property>
