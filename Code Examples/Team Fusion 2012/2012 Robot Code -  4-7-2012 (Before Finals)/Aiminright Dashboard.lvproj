...
<Project Type="Project" LVVersion="11008008">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Support" Type="Folder">
			<Item Name="Parse Digital Module.vi" Type="VI" URL="../Dashboard Code/Parse Digital Module.vi"/>
			<Item Name="Update Battery Indicator.vi" Type="VI" URL="../Dashboard Code/Update Battery Indicator.vi"/>
			<Item Name="Save DB Images.vi" Type="VI" URL="../Dashboard Code/Save DB Images.vi"/>
			<Item Name="Receive DS Packet.vi" Type="VI" URL="../Dashboard Code/Receive DS Packet.vi"/>
			<Item Name="App EXE.ico" Type="Document" URL="../Dashboard Code/App EXE.ico"/>
			<Item Name="Decode Status Byte.vi" Type="VI" URL="../Dashboard Code/Decode Status Byte.vi"/>
			<Item Name="Elapsed Time.vi" Type="VI" URL="../Dashboard Code/Elapsed Time.vi"/>
		</Item>
		<Item Name="TypeDefs" Type="Folder">
			<Item Name="DStoPCPacketTypeDef.ctl" Type="VI" URL="../Dashboard Code/DStoPCPacketTypeDef.ctl"/>
			<Item Name="Shooter Dashboard Package.ctl" Type="VI" URL="../Shared/Shooter Dashboard Package.ctl"/>
			<Item Name="Shifter State.ctl" Type="VI" URL="../Shared/Shifter State.ctl"/>
			<Item Name="Drive Base Dashboard Package.ctl" Type="VI" URL="../Shared/Drive Base Dashboard Package.ctl"/>
			<Item Name="Dashboard Datatype.ctl" Type="VI" URL="../Shared/Dashboard Datatype.ctl"/>
			<Item Name="cRIO Performance Details.ctl" Type="VI" URL="../Shared/cRIO Performance Details.ctl"/>
		</Item>
		<Item Name="Dashboard Main.vi" Type="VI" URL="../Dashboard Code/Dashboard Main.vi"/>
		<Item Name="Dashboard Global Data.vi" Type="VI" URL="../Dashboard Code/Dashboard Global Data.vi"/>
		<Item Name="Build Simple Skeleton Data.vi" Type="VI" URL="../Dashboard Code/Build Simple Skeleton Data.vi"/>
		<Item Name="Build Camera IP.vi" Type="VI" URL="../Dashboard Code/Build Camera IP.vi"/>
		<Item Name="Draw Simple Skeleton Picture.vi" Type="VI" URL="../Dashboard Code/Draw Simple Skeleton Picture.vi"/>
		<Item Name="Gauge Sweep.vi" Type="VI" URL="../Dashboard Code/Gauge Sweep.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Shooter Control Mode.ctl" Type="VI" URL="../Shared/Shooter Control Mode.ctl"/>
		</Item>
